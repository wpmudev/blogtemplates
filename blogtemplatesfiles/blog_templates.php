...
<?php
        ...
        */
		...
		function registration_template_selection () {
			...
			// Setup theme file
			$theme_file = locate_template(array('blog_templates-registration.php'));
			$theme_file = $theme_file ? $theme_file : $this->thispluginpath . 'template/blog_templates-registration.php';
