    ...
    */
    function get_options() {
        ...
        if (!$theOptions = get_site_option($this->options_name)) {
            $theOptions = self::get_default_settings();
            update_site_option($this->options_name, $theOptions);
        }
        
        $this->options = wp_parse_args( $theOptions, self::get_default_settings() );
    }
		            ...
		            <table class="form-table">
                        ...
                        <div id="screenshot-selection-styles">
                            <label style="margin-left:20px;margin-top:20px;display:block;">
                                <?php _e( 'Unselected background color screenshot', $this->localization_domain); ?><br/>
                                <input type="text" class="color-field" id="selected-background-color" name="unselected-background-color" value="<?php echo $this->options['unselected-background-color']; ?>" />
                            </label>
                            <label style="margin-left:20px;margin-top:20px;display:block;">
                                <?php _e( 'Selected background color screenshot', $this->localization_domain); ?><br/>
                                <input type="text" class="color-field" id="selected-background-color" name="selected-background-color" value="<?php echo $this->options['selected-background-color']; ?>" />
                            </label>
                        </div>
